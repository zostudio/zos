...
import com.asiainfo.rms.workflow.listener.baseLinstener.CreateTaskListener;
...
@Component("${processGM.userPreListener.implementation}")
public class PreTask extends CreateTaskListener {
