...
import com.zos.generate.generate.properties.TypeMappingPropertie;
import com.zos.generate.generate.provider.db.table.model.ForeignKey.ReferenceKey;
import com.zos.generate.generate.provider.db.table.model.util.ColumnHelper;
import com.zos.generate.generate.util.SpringHelper;
import com.zos.generate.generate.util.StringHelper;
import com.zos.generate.generate.util.TestDataGenerator;
import com.zos.generate.generate.util.typemapping.ActionScriptDataTypesUtils;
import com.zos.generate.generate.util.typemapping.DatabaseDataTypesUtils;
...
public class Column {
	...
	public String getJdbcSqlTypeName() {
		...
		// if(result == null) throw new RuntimeException("jdbcSqlTypeName is null
		// column:"+getSqlName()+" sqlType:"+getSqlType());
		return result;
	}
	...
	/**
	 * 得到JSR303 bean validation(Hibernate
	 * Validator)的验证表达式: @NotNull @Min(100) @Max(800)
	 */
	...
	private void initOtherProperties() {
		...
		TypeMappingPropertie typeMappingPropertie = null;
		for (TypeMappingPropertie typeMapping : generateProperties.getTypeMappings()) {
			if (normalJdbcJavaType.equals(typeMapping.getName())) {
				typeMappingPropertie = typeMapping;
				break;
			}
		}
		javaType = typeMappingPropertie == null ? normalJdbcJavaType : typeMappingPropertie.getValue();
	...
	/**
	 * public enum ${enumClassName} { ${enumAlias}(${enumKey},${enumDesc}); private
