...
public class ParsedSql {
	 ...
	 *            the position of the parameter (as index in the parameter names
	 *            List)
	...
	/**
	 * Set the count of named parameters in the SQL statement. Each parameter name
	 * counts once; repeated occurences do not count here.
	 */
	...
	/**
	 * Return the count of named parameters in the SQL statement. Each parameter
	...
	/**
	 * Set the total count of all of the parameters in the SQL statement. Repeated
	 * occurences of the same parameter name do count here.
	 */
