...
public interface Paranamer {
	 ...
	 *            the {@link Method} or {@link Constructor} for which the parameter
	 *            names are looked up.
	 ...
	 *             if reflection is not permitted on the containing {@link Class} of
	 *             the parameter
	 */
	 ...
	 *            whether to throw an exception if no Paranamer data found (versus
	 *            return null).
	 * @return A list of the parameter names.
	 * @throws ParameterNamesNotFoundException
	 *             if no parameter names were found.
